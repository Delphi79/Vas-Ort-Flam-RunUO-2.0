/* *
 * Packer898 Edited: 6/25/06
 * Lines Edited: 659-651, 679-690, 877
 * */
using System;
...
namespace Server
{
	public class LootPack
	{
		...
		{
		 	new LootPackEntry(  true, Gold,			100.00, "5d10+25" ),//75
		    new LootPackEntry( false, Instruments,	  0.10, 1 ),
		...
		{
			new LootPackEntry(  true, Gold,			100.00, "10d10+50" ),//150
		    new LootPackEntry( false, Instruments,	  0.40, 1 ),
		   	new LootPackEntry( false, OldMagicItems,	  5.00, 1, 1, 20, 80 ),
		    new LootPackEntry( false, OldMagicItems,	  2.00, 1, 1, 30, 90 ),
		    new LootPackEntry( false, OldMagicItems,	  0.50, 1, 1, 40, 90 )//0.50, 1, 1, 40, 100 )50% Chance to drop
		} );
		
		public static readonly LootPack OldRich = new LootPack( new LootPackEntry[]
		{
		 	new LootPackEntry(  true, Gold,			100.00, "10d10+250" ),//350
		    new LootPackEntry( false, Instruments,	  1.00, 1 ),
		    new LootPackEntry( false, OldMagicItems,	 40.00, 1, 1, 40, 80 ),//20.00, 1, 1, 60, 100 ),40% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 20.00, 1, 1, 60, 90 ),//10.00, 1, 1, 65, 100 ),20% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 10.00, 1, 1, 60, 100 )//1.00, 1, 1, 70, 100 )10% Chance to drop
		} );
		
		public static readonly LootPack OldFilthyRich = new LootPack( new LootPackEntry[]
		{
			new LootPackEntry(  true, Gold,			100.00, "2d125+400" ),//650
		    new LootPackEntry( false, Instruments,	  2.00, 1 ),
		    new LootPackEntry( false, OldMagicItems,	 65.00, 1, 1, 40, 70 ),//33.00, 1, 1, 50, 100 ),65% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 33.00, 1, 1, 50, 100 ),//33.00, 1, 1, 60, 100 ),33% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 33.00, 1, 1, 60, 90 ),//20.00, 1, 1, 70, 100 ),33% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 70, 100 )//5.00, 1, 1, 80, 100 )100% Chance to drop
		} );
		
		public static readonly LootPack OldUltraRich = new LootPack( new LootPackEntry[]
		{
			new LootPackEntry(  true, Gold,		    100.00, "5d100+500" ),//1000
		    new LootPackEntry( false, Instruments,    2.00, 1 ),
		    new LootPackEntry( false, OldMagicItems,	 50.00, 1, 1, 40, 80 ),//100.00, 1, 1, 40, 100 ),50% Chance to drop
		    new LootPackEntry( false, OldMagicItems,   100.00, 1, 1, 40, 90 ),//100.00, 1, 1, 40, 100 ),100% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 50.00, 1, 1, 50, 100 ),//100.00, 1, 1, 50, 100 ),50% Chance to drop
		    new LootPackEntry( false, OldMagicItems,   100.00, 1, 1, 50, 90 ),//100.00, 1, 1, 50, 100 ),100% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 75.00, 1, 1, 90, 100 ),//100.00, 1, 1, 60, 100 ),75% Chance to drop
		    new LootPackEntry( false, OldMagicItems,   100.00, 1, 1, 90, 100 )//100.00, 1, 1, 60, 100 )100% Chance to drop
		} );
		
		public static readonly LootPack OldSuperBoss = new LootPack( new LootPackEntry[]
		{
			new LootPackEntry(  true, Gold,			100.00, "5d100+500" ),//1000
		    new LootPackEntry( false, Instruments,	 10.00, 1 ),
		    new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 40, 80 ),//100.00, 1, 1, 40, 100 ),100% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 40, 90 ),//100.00, 1, 1, 40, 100 ),100% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 70.00, 1, 1, 50, 100 ),//100.00, 1, 1, 40, 100 ),70% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 50, 90 ),//100.00, 1, 1, 50, 100 ),100% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 60, 100 ),//100.00, 1, 1, 50, 100 ),100% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 70.00, 1, 1, 70, 100 ),//100.00, 1, 1, 50, 100 ),70% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 80.00, 1, 1, 70, 90 ),//100.00, 1, 1, 60, 100 ),80% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 70, 90 ),//100.00, 1, 1, 60, 100 ),100% Chance to drop
		    new LootPackEntry( false, OldMagicItems,	 60.00, 1, 1, 70, 100 ),//100.00, 1, 1, 60, 100 ),60% Chance to drop
