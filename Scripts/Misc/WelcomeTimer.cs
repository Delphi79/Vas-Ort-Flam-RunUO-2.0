		...
		private static string[] m_Messages = ( TestCenter.Enabled ?
			...
			new string[]
				{	"Welcome to Project X!",
					"If this is your first visit, then you have 3 skills to pick from to set to 100. These skillpoints are for your account, and not just this player. This means that you can save these skillpoints for another character. Choose wisely!",
