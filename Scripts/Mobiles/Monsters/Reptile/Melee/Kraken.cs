...
namespace Server.Mobiles
{
	...
	public class Kraken : BaseCreature
	{
		...
		public Kraken() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			if( Utility.RandomDouble() < .15 )//Added if statement for 15% chance to drop rope instead of distro 100%
			{
				Rope rope = new Rope();
				rope.ItemID = 0x14F8;
				PackItem( rope );
		...
		public override bool HasBreath{ get{ return true; } } //Added krakens had breath attack in UO:R
