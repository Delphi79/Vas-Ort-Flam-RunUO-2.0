...
namespace Server.Mobiles
{
	...
	public class PlayerMobile : Mobile, IHonorTarget
	{
        ...
        private bool _Lead;
        [CommandProperty(AccessLevel.Administrator)]
        public bool Lead { get { return _Lead; } set { _Lead = value; } }
		...
		public BaseExplosionPotion ExploPot;
        ...
        {
            if (target.Kills > 4 && this.Kills > 4)
                return false;
		...
		public override void OnDamage( int amount, Mobile from, bool willKill )
		{
            ...
            if (willKill)
                Statistics.StatisticController.HandleDeath(this, from);

            if (willKill && from.Player)
                Statistics.StatisticController.HandleKill(from, this);
		...
		public override void Resurrect()
		{
            ...
            //if (Server.Custom.PvpToolkit.PvpCore.IsInDeathmatch(this))
            //{
                //ReEquip();
                //return;
            //}
        ...
        //private ArrayList m_ReEquipTable = new ArrayList();

        /*private void ReEquip()
        {
           for (int i = 0; i < m_ReEquipTable.Count; i++)
            {
                Item item = (Item)m_ReEquipTable[i];
                this.EquipItem(item);
            }
        }*/
		...
		public override bool OnBeforeDeath()
		{
            ...
            /*if (Server.Custom.PvpToolkit.PvpCore.IsInDeathmatch(this))
            {
                m_ReEquipTable = new ArrayList();

                foreach (Layer l in Server.Custom.PvpToolkit.PvpCore.EquipmentLayers)
                {
                    Item i = FindItemOnLayer(l);

                    if (i != null)
                        m_ReEquipTable.Add(i);
                }
            }*/
		...
		public override bool IsHarmfulCriminal( Mobile target )
		{
            ...
            if (this.Kills > 4 && target.Kills > 4)
                return false;
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
                case 27:
                    {
                        _CustomTitle = reader.ReadString();
                        goto case 26;
                    }
                case 26:
                    {
                        _Lead = reader.ReadBool();
                        goto case 25;
                    }
				case 25:
				{
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            writer.Write((string)_CustomTitle);
            writer.Write((bool)_Lead);
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            {
               PrivateOverheadMessage(MessageType.Label, 0x38, true, String.Format("({0})", CustomTitle), from.NetState);
            }
        }
