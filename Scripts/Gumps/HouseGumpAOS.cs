			...
			switch ( page )
			{
				...
				case HouseGumpPageAOS.Security:
				{
					...
					else
					{
						...
						AddButton( 210, 180, 4005, 4007, 2019, GumpButtonType.Reply, 0 ); // Button Change Locks
						AddHtml( 245, 182, 250, 19, Color( "Change House Locks", 0xFFFFFF ), false, false ); // Label Change Locks
					}
