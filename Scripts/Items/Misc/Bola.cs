...
namespace Server.Items
{
	public class Bola : Item
	{
		...
		public static void FinishThrow( object state )
		{
            ...
            int chance = (int)from.Skills.Tactics.Value;

            if (!(chance >= Utility.Random(100) + 1))
            {
                from.SendMessage("You have failed to knock the rider of their mount");
                return;
            }
