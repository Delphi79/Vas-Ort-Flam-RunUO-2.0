...
namespace Server.Gumps
{
	...
	public class GumpRemoveID : Gump
	{
		...
		public GumpRemoveID( CommandEventArgs e ) : base( 50,50 )
		{
			...
			AddImageTiled( 15, 30, 120, 20, 3004 );
			AddLabel( 15, 10, 52, "Enter an SpawnID:" );
			AddButton( 140, 32, 0x15E1, 0x15E5, 101, GumpButtonType.Reply, 0 );

			AddLabel( 15, 60, 52, "Tip:" );
			AddHtml( 15, 80, 140, 110, "This command was made to UNLOAD your own custom maps. This will REMOVE the spawners with the a specified ID. Type '[get spawnid' in a spawner to know your ID. Remember: 'By Hand' spawns, i.e., those done with '[add premiumspawner...', has ID = 1.", true, true );
		}
