                                                                ...
                                                                if (kw == typemodKeyword.MSG)
                                                                {
                                                                    ...
                                                                    if (kw == typemodKeyword.ASCIIMSG)
                                                                    {
                                                                        ...
                                                                        if (kw == typemodKeyword.SENDMSG)
                                                                        {
                                                                            ...
                                                                            if (kw == typemodKeyword.SENDASCIIMSG)
                                                                            {
                        ...
                        if (rangelist != null)
                        {
                            foreach (Mobile p in rangelist)
                            {
                                if (!petres && p is PlayerMobile && p.Body.IsGhost)
                                {
                                    ...
                                    if (petres && p is BaseCreature && ((BaseCreature)p).ControlMaster == triggermob && ((BaseCreature)p).Controlled && ((BaseCreature)p).IsDeadPet)
                                    {
